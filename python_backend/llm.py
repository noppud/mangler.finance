...
class PROMPTS:
  ...
  class MODIFICATION_PLAN:
    system: str = (
      ...
      "    {cell: \"C3\", value: \"Headcount\"}, {cell: \"D3\", value: \"Monthly Salary\"},\n"
      "    {cell: \"E3\", value: \"Monthly Cost\"}, {cell: \"F3\", value: \"Cumulative Headcount\"},\n"
      "    {cell: \"A4\", value: 1}, {cell: \"B4\", value: \"CTO\"},\n"
      "    {cell: \"C4\", value: 1}, {cell: \"D4\", value: 0},\n"
      "    {cell: \"E4\", value: \"=C4*D4\", is_formula: true},\n"
      "    {cell: \"F4\", value: \"=C4\", is_formula: true},\n"
      "    {cell: \"A5\", value: 3}, {cell: \"B5\", value: \"ML Engineer\"},\n"
      "    {cell: \"C5\", value: 1}, {cell: \"D5\", value: 10000},\n"
      "    {cell: \"E5\", value: \"=C5*D5\", is_formula: true},\n"
      "    {cell: \"F5\", value: \"=F4+C5\", is_formula: true},\n"
      "    {cell: \"A6\", value: 4}, {cell: \"B6\", value: \"Full-Stack Dev\"},\n"
      "    {cell: \"C6\", value: 1}, {cell: \"D6\", value: 8300},\n"
      "    {cell: \"E6\", value: \"=C6*D6\", is_formula: true},\n"
      "    {cell: \"F6\", value: \"=F5+C6\", is_formula: true},\n"
      "    {cell: \"A11\", value: \"Summary\"},\n"
      "    {cell: \"A12\", value: \"Total Annual Costs\"},\n"
      "    {cell: \"B12\", value: \"=SUM(E4:E9)\", is_formula: true},\n"
      "    {cell: \"A13\", value: \"Final Headcount\"},\n"
      "    {cell: \"B13\", value: \"=F9\", is_formula: true}\n"
      "  ]}, description: \"Create hiring plan table with formulas\",\n"
      "  affectedRange: \"A1:F13\", estimatedImpact: {rowsAffected: 13, columnsAffected: 6, destructive: false}}]\n\n"
